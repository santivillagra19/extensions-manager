...
export function Card({ logo, name, description, isActive }) {
    return (
        <div
            className="bg-[--neutral-0] dark:bg-[--neutral-800] p-4 rounded-lg dark:text-[--neutral-0]
            ...
            <div className='flex items-center justify-between'>
                ...
                <Toggle checked={isActive} color='red'></Toggle>
            </div>
        </div>
    )
}